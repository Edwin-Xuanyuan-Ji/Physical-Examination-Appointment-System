...
import com.jxy.service.ReportService;
...
//导出运营数据
@RequestMapping("/exportBusinessReportData")
public Result exportBusinessReportData(HttpServletRequest request, HttpServletResponse response){
        try{
...
//导出运营数据到PDF，并提供客户端下载
@RequestMapping("/exportBusinessReportData4PDF")
public Result exportBusinessReportData4PDF(HttpServletRequest request, HttpServletResponse response){
        try{
        Map<String,Object> result = reportService.getBusinessReportData();
